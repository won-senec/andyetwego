...
# quietly making private writing public again is the worse failure. Delete a
# name from both sets only when the intent really is to publish, as was done for
